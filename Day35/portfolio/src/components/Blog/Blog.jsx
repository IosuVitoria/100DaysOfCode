    ...
    <div className="blog__post">
      <div className='blog__post__content'>
        ...
        <div className='blog__post__content__text'>
          ...
          <p>Toda la vida me ha gustado la informática. Todavía recuerdo el primer ordenador que vi con 11 años en el colegio. Un IBM que distaba mucho de ser moderno para su época pero en el cual tuve acceso a un primer editor de texto. No me olvidaré jamás el brillo de esa pantalla azul y de lo alucinado que me quedé por ver que se podían elegir varios colores a la par que se escribía el texto.</p>
          <p>Poco más tarde, llegaría a casa el primer ordenador que pude utilizar a diario. Montaba el sistema operativo Windows 95 y en la torre tenía un poderosísimo Pentium a 133MH, 32MB de RAM y 2GB de disco duro. Esto ahora suena a broma y a un fósil de la tecnología pero en aquel momento me permitió usar Office de la época y jugar al primer juego de Age of Empires (en el cual mi hermano pequeño y yo pasamos innumerables horas).</p>
          <p>Ese ordenador sufrió un ciberataque. Un virus hizo que el disco magnético girara a toda velocidad y la aguja al intentar leerlo lo partió dejándolo inservible. Tras la sustitució por uno de 4GB, la tienda nos devolvió el disco roto  y tuve por primera vez un componente de pc en la mano. Una anécdota que no hizo sino avivar mi interés por la informática y la electrónica.</p>
          <p>Llegaría el final del instituto y mi primer verano trabajando. Mi primer sueldo fue íntegro para la compra de un portátil. Un AH-TEC que me acompañó durante años y que a día de hoy salvo por la batería agotada y la bisagra rota sigue arrancando y funcionando perfectamente. Ruge como un león pero le tengo mucho cariño. Fueron muchas horas de trabajo pasadas delante de esa pantalla, mi primer sueldo y viajes continuos de idas y venidas a la universidad. Ese ordenador es para mí algo así como el primer coche en el que uno conduce. Se queda viejito y tiene sus cosas pero lo aprecias por todo el tiempo pasado y el servicio que te ha dado.</p>
          <p>Años más tarde, llegaría mi inicio oficial en la programación con mi tesina de máster. Elegí Python para ponerme a trabajar y desarrollé mi trabajo en este lenguaje. Desde ese momento quedó una espina dentro de mí que años más tarde saldría a la luz.</p>
          <p>Y hace nada, un periodo muy duro a nivel personal me hizo darme cuente de lo que quería y deseaba. Gracias al apoyo de mi pareja y los consejos de un buen amigo decidí dar el salto y dedicarme a programar. A seguir formándome y crecer en un campo del que llevo enganchado desde que vi las letras IBM mostrándose en la pantalla.</p>
        </div>
      </div>
